// -------------------------------------------------------------
// 
// File Name: C:\Users\Hassa\Documents\GitHub\vocoder\MATLAB\MATLAB_CodeGen\codegen\envelopeModulation\hdlsrc\SDFCommutator2_block1.sv
...
// Source Path: envelopeModulation_fixpt/dsphdl.FFT/RADIX22FFT_SDF2_2/SDFCommutator2
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module SDFCommutator2_block1
          (  input logic clk,
             ...
             input logic signed [14:0] xf_re  /* sfix15 */,
             input logic signed [14:0] xf_im  /* sfix15 */,
             input logic xf_vld,
             input logic signed [14:0] dinf_re  /* sfix15 */,
             input logic signed [14:0] dinf_im  /* sfix15 */,
             input logic dinf_vld,
             input logic signed [14:0] btf1_re  /* sfix15 */,
             input logic signed [14:0] btf1_im  /* sfix15 */,
             input logic signed [14:0] btf2_re  /* sfix15 */,
             input logic signed [14:0] btf2_im  /* sfix15 */,
             input logic btfout_vld,
             input logic softReset,
             output logic signed [14:0] wrData_re  /* sfix15 */,
             output logic signed [14:0] wrData_im  /* sfix15 */,
             output logic [7:0] wrAddr  /* ufix8 */,
             output logic wrEnb,
  ...
  logic signed [14:0] SDFCummutator_out_re;  /* sfix15 */
  logic signed [14:0] SDFCummutator_out_im;  /* sfix15 */
  logic SDFCummutator_out_vld;
  logic [7:0] SDFCummutator_wrAddr_reg;  /* ufix8 */
  logic [2:0] SDFCummutator_wrState;  /* ufix3 */
  logic [1:0] SDFCummutator_mem_btf_switch;  /* ufix2 */
  logic [7:0] SDFCummutator_rdCnt;  /* ufix8 */
  logic signed [14:0] SDFCummutator_wrData_re_reg;  /* sfix15 */
  logic signed [14:0] SDFCummutator_wrData_im_reg;  /* sfix15 */
  logic SDFCummutator_wrEnb_reg;
  logic signed [14:0] SDFCummutator_wrXData_re_reg;  /* sfix15 */
  logic signed [14:0] SDFCummutator_wrXData_im_reg;  /* sfix15 */
  ...
  logic signed [14:0] SDFCummutator_out_re_next;  /* sfix15 */
  logic signed [14:0] SDFCummutator_out_im_next;  /* sfix15 */
  logic SDFCummutator_out_vld_next;
  logic [7:0] SDFCummutator_wrAddr_reg_next;  /* ufix8 */
  logic [2:0] SDFCummutator_wrState_next;  /* ufix3 */
  logic [1:0] SDFCummutator_mem_btf_switch_next;  /* ufix2 */
  logic [7:0] SDFCummutator_rdCnt_next;  /* ufix8 */
  logic signed [14:0] SDFCummutator_wrData_re_reg_next;  /* sfix15 */
  logic signed [14:0] SDFCummutator_wrData_im_reg_next;  /* sfix15 */
  logic SDFCummutator_wrEnb_reg_next;
  logic signed [14:0] SDFCummutator_wrXData_re_reg_next;  /* sfix15 */
  logic signed [14:0] SDFCummutator_wrXData_im_reg_next;  /* sfix15 */
  ...
  logic signed [14:0] wrData_re_1;  /* sfix15 */
  logic signed [14:0] wrData_im_1;  /* sfix15 */
  logic [7:0] wrAddr_1;  /* ufix8 */
  logic wrEnb_1;
  logic signed [14:0] xData_re;  /* sfix15 */
  logic signed [14:0] xData_im;  /* sfix15 */
  logic [2:0] wrXAddr;  /* ufix3 */
  logic wrXEnb;
  logic [2:0] rdXAddr;  /* ufix3 */
  logic xX_vld;
  logic signed [14:0] dout0_re;  /* sfix15 */
  logic signed [14:0] dout0_im;  /* sfix15 */
  logic dout0_vld;
  logic signed [14:0] xX_re;  /* sfix15 */
  logic signed [14:0] xX_im;  /* sfix15 */
  logic signed [14:0] SDFOutmux_btf2Pipe_re;  /* sfix15 */
  logic signed [14:0] SDFOutmux_btf2Pipe_im;  /* sfix15 */
  logic SDFOutmux_btfPipe_vld;
  logic signed [14:0] SDFOutmux_btf2Pipe_re_next;  /* sfix15 */
  logic signed [14:0] SDFOutmux_btf2Pipe_im_next;  /* sfix15 */
  logic SDFOutmux_btfPipe_vld_next;
  logic signed [14:0] dout_2_1_re_1;  /* sfix15 */
  logic signed [14:0] dout_2_1_im_1;  /* sfix15 */
