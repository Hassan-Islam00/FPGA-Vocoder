// -------------------------------------------------------------
// 
// File Name: C:\Users\Hassa\Documents\GitHub\vocoder\MATLAB\MATLAB_CodeGen\codegen\envelopeModulation\hdlsrc\SDFCommutator4_block1.sv
...
// Source Path: envelopeModulation_fixpt/dsphdl.FFT/RADIX22FFT_SDF2_4/SDFCommutator4
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module SDFCommutator4_block1
          (  input logic clk,
             ...
             input logic signed [16:0] xf_re  /* sfix17 */,
             input logic signed [16:0] xf_im  /* sfix17 */,
             input logic xf_vld,
             input logic signed [16:0] dinf_re  /* sfix17 */,
             input logic signed [16:0] dinf_im  /* sfix17 */,
             input logic dinf_vld,
             input logic signed [16:0] btf1_re  /* sfix17 */,
             input logic signed [16:0] btf1_im  /* sfix17 */,
             input logic signed [16:0] btf2_re  /* sfix17 */,
             input logic signed [16:0] btf2_im  /* sfix17 */,
             input logic btfout_vld,
             input logic softReset,
             output logic signed [16:0] wrData_re  /* sfix17 */,
             output logic signed [16:0] wrData_im  /* sfix17 */,
  ...
  logic signed [16:0] SDFCummutator_out_re_next;  /* sfix17 */
  logic signed [16:0] SDFCummutator_out_im_next;  /* sfix17 */
  ...
  logic signed [16:0] SDFCummutator_wrData_re_reg_next;  /* sfix17 */
  logic signed [16:0] SDFCummutator_wrData_im_reg_next;  /* sfix17 */
  logic SDFCummutator_wrEnb_reg_next;
  logic signed [16:0] SDFCummutator_wrXData_re_reg_next;  /* sfix17 */
  logic signed [16:0] SDFCummutator_wrXData_im_reg_next;  /* sfix17 */
  ...
  logic signed [16:0] wrData_re_1;  /* sfix17 */
  logic signed [16:0] wrData_im_1;  /* sfix17 */
  logic [5:0] wrAddr_1;  /* ufix6 */
  logic wrEnb_1;
  logic signed [16:0] xData_re;  /* sfix17 */
  logic signed [16:0] xData_im;  /* sfix17 */
  logic [2:0] wrXAddr;  /* ufix3 */
  logic wrXEnb;
  logic [2:0] rdXAddr;  /* ufix3 */
  logic xX_vld;
  logic signed [16:0] dout0_re;  /* sfix17 */
  logic signed [16:0] dout0_im;  /* sfix17 */
  logic dout0_vld;
  logic signed [16:0] xX_re;  /* sfix17 */
  logic signed [16:0] xX_im;  /* sfix17 */
  logic signed [16:0] SDFOutmux_btf2Pipe_re;  /* sfix17 */
  logic signed [16:0] SDFOutmux_btf2Pipe_im;  /* sfix17 */
  logic SDFOutmux_btfPipe_vld;
  logic signed [16:0] SDFOutmux_btf2Pipe_re_next;  /* sfix17 */
  logic signed [16:0] SDFOutmux_btf2Pipe_im_next;  /* sfix17 */
  logic SDFOutmux_btfPipe_vld_next;
  logic signed [16:0] dout_4_1_re_1;  /* sfix17 */
  logic signed [16:0] dout_4_1_im_1;  /* sfix17 */
