// -------------------------------------------------------------
// 
// File Name: C:\Users\Hassa\Documents\GitHub\vocoder\MATLAB\MATLAB_CodeGen\codegen\envelopeModulation\hdlsrc\SDFCommutator9_block1.sv
...
// Source Path: envelopeModulation_fixpt/dsphdl.FFT/RADIX22FFT_SDF1_9/SDFCommutator9
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module SDFCommutator9_block1
          (  input logic clk,
             ...
             input logic signed [21:0] xf_re  /* sfix22 */,
             input logic signed [21:0] xf_im  /* sfix22 */,
             input logic xf_vld,
             input logic signed [21:0] dinXTwdlf_re  /* sfix22 */,
             input logic signed [21:0] dinXTwdlf_im  /* sfix22 */,
             input logic dinxTwdlf_vld,
             input logic signed [21:0] btf1_re  /* sfix22 */,
             input logic signed [21:0] btf1_im  /* sfix22 */,
             input logic signed [21:0] btf2_re  /* sfix22 */,
             input logic signed [21:0] btf2_im  /* sfix22 */,
             input logic btf_vld,
             input logic softReset,
             output logic signed [21:0] wrData_re  /* sfix22 */,
             output logic signed [21:0] wrData_im  /* sfix22 */,
  ...
  logic signed [21:0] SDFCummutator_out_re_next;  /* sfix22 */
  logic signed [21:0] SDFCummutator_out_im_next;  /* sfix22 */
  logic SDFCummutator_out_vld_next;
  logic SDFCummutator_wrAddr_reg_next;  /* ufix1 */
  logic [2:0] SDFCummutator_wrState_next;  /* ufix3 */
  logic signed [21:0] SDFCummutator_wrData_re_reg_next;  /* sfix22 */
  logic signed [21:0] SDFCummutator_wrData_im_reg_next;  /* sfix22 */
  logic SDFCummutator_wrEnb_reg_next;
  logic signed [21:0] SDFCummutator_wrXData_re_reg_next;  /* sfix22 */
  logic signed [21:0] SDFCummutator_wrXData_im_reg_next;  /* sfix22 */
  ...
  logic signed [21:0] wrData_re_1;  /* sfix22 */
  logic signed [21:0] wrData_im_1;  /* sfix22 */
  logic wrAddr_1;  /* ufix1 */
  logic wrEnb_1;
  logic signed [21:0] xData_re;  /* sfix22 */
  logic signed [21:0] xData_im;  /* sfix22 */
  logic [2:0] wrXAddr;  /* ufix3 */
  logic wrXEnb;
  logic [2:0] rdXAddr;  /* ufix3 */
  logic xX_vld;
  logic signed [21:0] dout0_re;  /* sfix22 */
  logic signed [21:0] dout0_im;  /* sfix22 */
  logic dout0_vld;
  logic signed [21:0] xX_re;  /* sfix22 */
  logic signed [21:0] xX_im;  /* sfix22 */
  logic signed [21:0] SDFOutmux_btf2Pipe_re;  /* sfix22 */
  logic signed [21:0] SDFOutmux_btf2Pipe_im;  /* sfix22 */
  logic SDFOutmux_btfPipe_vld;
  logic signed [21:0] SDFOutmux_btf2Pipe_re_next;  /* sfix22 */
  logic signed [21:0] SDFOutmux_btf2Pipe_im_next;  /* sfix22 */
  logic SDFOutmux_btfPipe_vld_next;
  logic signed [21:0] dout_9_1_re_1;  /* sfix22 */
  logic signed [21:0] dout_9_1_im_1;  /* sfix22 */
  logic dout_9_1_vld_1;
...
endmodule  // SDFCommutator9_block1
