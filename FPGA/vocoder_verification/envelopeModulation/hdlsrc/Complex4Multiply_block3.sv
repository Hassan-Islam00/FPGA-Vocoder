// -------------------------------------------------------------
// 
// File Name: C:\Users\Hassa\Documents\GitHub\vocoder\MATLAB\MATLAB_CodeGen\codegen\envelopeModulation\hdlsrc\Complex4Multiply_block3.sv
...
// Source Path: envelopeModulation_fixpt/dsphdl.FFT/RADIX22FFT_SDF1_3/Complex4Multiply
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module Complex4Multiply_block3
          (  input logic clk,
             input logic reset,
             input logic enb,
             input logic signed [15:0] din_re  /* sfix16 */,
             input logic signed [15:0] din_im  /* sfix16 */,
             ...
             output logic signed [15:0] dinXTwdl_re  /* sfix16 */,
             output logic signed [15:0] dinXTwdl_im  /* sfix16 */,
             output logic dinXTwdl_3_1_vld);


  logic signed [15:0] din_re_reg;  /* sfix16 */
  logic signed [15:0] din_im_reg;  /* sfix16 */
  logic signed [12:0] twdl_re_reg;  /* sfix13_En11 */
  logic signed [12:0] twdl_im_reg;  /* sfix13_En11 */
  logic signed [15:0] Complex4Multiply_din1_re_pipe1;  /* sfix16 */
  logic signed [15:0] Complex4Multiply_din1_im_pipe1;  /* sfix16 */
  logic signed [28:0] Complex4Multiply_mult1_re_pipe1;  /* sfix29 */
  logic signed [28:0] Complex4Multiply_mult2_re_pipe1;  /* sfix29 */
  logic signed [28:0] Complex4Multiply_mult1_im_pipe1;  /* sfix29 */
  logic signed [28:0] Complex4Multiply_mult2_im_pipe1;  /* sfix29 */
  logic signed [12:0] Complex4Multiply_twiddle_re_pipe1;  /* sfix13 */
  logic signed [12:0] Complex4Multiply_twiddle_im_pipe1;  /* sfix13 */
  logic signed [28:0] prod1_re;  /* sfix29_En11 */
  logic signed [28:0] prod1_im;  /* sfix29_En11 */
  logic signed [28:0] prod2_re;  /* sfix29_En11 */
  logic signed [28:0] prod2_im;  /* sfix29_En11 */
  logic din_vld_dly1;
  logic din_vld_dly2;
  logic din_vld_dly3;
  logic prod_vld;
  logic signed [29:0] Complex4Add_multRes_re_reg;  /* sfix30 */
  logic signed [29:0] Complex4Add_multRes_im_reg;  /* sfix30 */
  logic Complex4Add_prod_vld_reg1;
  logic signed [28:0] Complex4Add_prod1_re_reg;  /* sfix29 */
  logic signed [28:0] Complex4Add_prod1_im_reg;  /* sfix29 */
  logic signed [28:0] Complex4Add_prod2_re_reg;  /* sfix29 */
  logic signed [28:0] Complex4Add_prod2_im_reg;  /* sfix29 */
  logic signed [29:0] Complex4Add_multRes_re_reg_next;  /* sfix30_En11 */
  logic signed [29:0] Complex4Add_multRes_im_reg_next;  /* sfix30_En11 */
  logic signed [29:0] Complex4Add_sub_cast;  /* sfix30_En11 */
  logic signed [29:0] Complex4Add_sub_cast_1;  /* sfix30_En11 */
  logic signed [29:0] Complex4Add_add_cast;  /* sfix30_En11 */
  logic signed [29:0] Complex4Add_add_cast_1;  /* sfix30_En11 */
  logic signed [29:0] mulResFP_re;  /* sfix30_En11 */
  logic signed [29:0] mulResFP_im;  /* sfix30_En11 */
  ...
  assign dinXTwdl_re = mulResFP_re[26:11];



  assign dinXTwdl_im = mulResFP_im[26:11];
