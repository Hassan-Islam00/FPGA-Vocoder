// -------------------------------------------------------------
// 
// File Name: C:\Users\Hassa\Documents\GitHub\vocoder\MATLAB\MATLAB_CodeGen\codegen\envelopeModulation\hdlsrc\RADIX22FFT_CTRL1_7_block1.sv
...
// Source Path: envelopeModulation_fixpt/dsphdl.FFT/RADIX22FFT_CTRL1_7
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module RADIX22FFT_CTRL1_7_block1
          (  input logic clk,
             ...
             output logic [2:0] rd_7_Addr  /* ufix3 */,
             output logic rd_7_Enb,
             output logic proc_7_enb,
             output logic multiply_7_J);
  ...
  logic [2:0] rd_7_Addr_1;  /* ufix3 */
  logic rd_7_Enb_1;
  logic proc_7_enb_1;
  logic multiply_7_J_1;
  ...
  always @(SDFController_multiply_J_reg, SDFController_multjState,
    ...
    multiply_7_J_1 = SDFController_multiply_J_reg;
  end
  ...
  assign multiply_7_J = multiply_7_J_1;

endmodule  // RADIX22FFT_CTRL1_7_block1
