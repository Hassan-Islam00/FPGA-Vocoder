// -------------------------------------------------------------
// 
// File Name: C:\Users\Hassa\Documents\GitHub\vocoder\MATLAB\MATLAB_CodeGen\codegen\envelopeModulation\hdlsrc\Quadrant_Mapper.sv
...
module Quadrant_Mapper
  ...
  logic signed [23:0] in2reg;  /* sfix24 */
  logic yZero;  /* ufix1 */
  logic signed [23:0] in1reg;  /* sfix24 */
  ...
  always_ff @(posedge clk or posedge reset)
    begin : Delayin2_process
      if (reset == 1'b1) begin
        in2reg <= 24'sb000000000000000000000000;
      end
      else begin
        if (enb) begin
          in2reg <= yin;
  ...
  assign yZero = in2reg == 24'sb000000000000000000000000;
  ...
  always_ff @(posedge clk or posedge reset)
    begin : Delayin1_process
      if (reset == 1'b1) begin
        in1reg <= 24'sb000000000000000000000000;
      end
      else begin
        if (enb) begin
          in1reg <= xin;
  ...
  assign xPositive = in1reg >= 24'sb000000000000000000000000;
  ...
  assign xNegative = in1reg < 24'sb000000000000000000000000;
  ...
  assign yNegative = in2reg < 24'sb000000000000000000000000;



  assign qcControl = {yZeroXPositive, yZeroXNegative, relop_relop1, xNegative, yNegative};
