// -------------------------------------------------------------
// 
// File Name: C:\Users\Hassa\Documents\GitHub\vocoder\MATLAB\MATLAB_CodeGen\codegen\envelopeModulation\hdlsrc\RADIX22FFT_CTRL1_9_block1.sv
...
// Source Path: envelopeModulation_fixpt/dsphdl.FFT/RADIX22FFT_CTRL1_9
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module RADIX22FFT_CTRL1_9_block1
          (  input logic clk,
             input logic reset,
             input logic enb,
             input logic dinXTwdl_9_1_vld,
             input logic dinXTwdl_9_1_vld_1,
             input logic softReset,
             output logic rd_9_Addr  /* ufix1 */,
             output logic rd_9_Enb,
             output logic proc_9_enb,
             output logic multiply_9_J);
  ...
  logic rd_9_Addr_1;  /* ufix1 */
  logic rd_9_Enb_1;
  logic proc_9_enb_1;
  logic multiply_9_J_1;
  ...
  always @(SDFController_multiply_J_reg, SDFController_multjState,
    ...
    multiply_9_J_1 = SDFController_multiply_J_reg;
  end
  ...
  assign multiply_9_J = multiply_9_J_1;

endmodule  // RADIX22FFT_CTRL1_9_block1
