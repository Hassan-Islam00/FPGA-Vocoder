// -------------------------------------------------------------
// 
// File Name: C:\Users\Hassa\Documents\GitHub\vocoder\MATLAB\MATLAB_CodeGen\codegen\envelopeModulation\hdlsrc\dsphdl_FFT.sv
...
module dsphdl_FFT
  ...
  TWDLROM_7_1_block u_twdlROM_7_1 (.clk(clk),
                                   .reset(reset),
                                   .enb(enb),
                                   .dout_6_1_vld(dout_6_1_vld),
                                   .softReset(softReset),
  ...
  RADIX22FFT_CTRL1_7_block u_CTRL1_7_1 (.clk(clk),
                                        .reset(reset),
                                        .enb(enb),
  ...
  RADIX22FFT_SDF1_7_block u_SDF1_7_1 (.clk(clk),
                                      .reset(reset),
                                      .enb(enb),
  ...
  RADIX22FFT_CTRL1_8_block u_CTRL2_8_1 (.clk(clk),
                                        .reset(reset),
                                        .enb(enb),
                                        .dout_7_1_vld(dout_7_1_vld),
  ...
  RADIX22FFT_SDF2_8_block u_SDF2_8_1 (.clk(clk),
                                      .reset(reset),
                                      .enb(enb),
                                      .dout_7_1_re(dout_7_1_re),  /* sfix20 */
                                      .dout_7_1_im(dout_7_1_im),  /* sfix20 */
  ...
  TWDLROM_9_1_block u_twdlROM_9_1 (.clk(clk),
                                   .reset(reset),
                                   .enb(enb),
                                   .dout_8_1_vld(dout_8_1_vld),
                                   .softReset(softReset),
  ...
  RADIX22FFT_CTRL1_9_block u_CTRL1_9_1 (.clk(clk),
                                        .reset(reset),
                                        .enb(enb),
  ...
  RADIX22FFT_SDF1_9_block u_SDF1_9_1 (.clk(clk),
                                      .reset(reset),
                                      .enb(enb),
  ...
  RADIX22FFT_CTRL1_10_block u_CTRL2_10_1 (.clk(clk),
                                          .reset(reset),
                                          .enb(enb),
                                          .dout_9_1_vld(dout_9_1_vld),
  ...
  RADIX22FFT_SDF2_10_block u_SDF2_10_1 (.clk(clk),
                                        .reset(reset),
                                        .enb(enb),
                                        .dout_9_1_re(dout_9_1_re),  /* sfix22 */
                                        .dout_9_1_im(dout_9_1_im),  /* sfix22 */
