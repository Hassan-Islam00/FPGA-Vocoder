// -------------------------------------------------------------
// 
// File Name: C:\Users\Hassa\Documents\GitHub\vocoder\MATLAB\MATLAB_CodeGen\codegen\envelopeModulation\hdlsrc\SDFCommutator5_block1.sv
...
// Source Path: envelopeModulation_fixpt/dsphdl.FFT/RADIX22FFT_SDF1_5/SDFCommutator5
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module SDFCommutator5_block1
          (  input logic clk,
             ...
             input logic signed [17:0] xf_re  /* sfix18 */,
             input logic signed [17:0] xf_im  /* sfix18 */,
             input logic xf_vld,
             input logic signed [17:0] dinXTwdlf_re  /* sfix18 */,
             input logic signed [17:0] dinXTwdlf_im  /* sfix18 */,
             input logic dinxTwdlf_vld,
             input logic signed [17:0] btf1_re  /* sfix18 */,
             input logic signed [17:0] btf1_im  /* sfix18 */,
             input logic signed [17:0] btf2_re  /* sfix18 */,
             input logic signed [17:0] btf2_im  /* sfix18 */,
             input logic btf_vld,
             input logic softReset,
             output logic signed [17:0] wrData_re  /* sfix18 */,
             output logic signed [17:0] wrData_im  /* sfix18 */,
  ...
  logic signed [17:0] SDFCummutator_out_re_next;  /* sfix18 */
  logic signed [17:0] SDFCummutator_out_im_next;  /* sfix18 */
  ...
  logic signed [17:0] SDFCummutator_wrData_re_reg_next;  /* sfix18 */
  logic signed [17:0] SDFCummutator_wrData_im_reg_next;  /* sfix18 */
  logic SDFCummutator_wrEnb_reg_next;
  logic signed [17:0] SDFCummutator_wrXData_re_reg_next;  /* sfix18 */
  logic signed [17:0] SDFCummutator_wrXData_im_reg_next;  /* sfix18 */
  ...
  logic signed [17:0] wrData_re_1;  /* sfix18 */
  logic signed [17:0] wrData_im_1;  /* sfix18 */
  logic [4:0] wrAddr_1;  /* ufix5 */
  logic wrEnb_1;
  logic signed [17:0] xData_re;  /* sfix18 */
  logic signed [17:0] xData_im;  /* sfix18 */
  logic [2:0] wrXAddr;  /* ufix3 */
  logic wrXEnb;
  logic [2:0] rdXAddr;  /* ufix3 */
  logic xX_vld;
  logic signed [17:0] dout0_re;  /* sfix18 */
  logic signed [17:0] dout0_im;  /* sfix18 */
  logic dout0_vld;
  logic signed [17:0] xX_re;  /* sfix18 */
  logic signed [17:0] xX_im;  /* sfix18 */
  logic signed [17:0] SDFOutmux_btf2Pipe_re;  /* sfix18 */
  logic signed [17:0] SDFOutmux_btf2Pipe_im;  /* sfix18 */
  logic SDFOutmux_btfPipe_vld;
  logic signed [17:0] SDFOutmux_btf2Pipe_re_next;  /* sfix18 */
  logic signed [17:0] SDFOutmux_btf2Pipe_im_next;  /* sfix18 */
  logic SDFOutmux_btfPipe_vld_next;
  logic signed [17:0] dout_5_1_re_1;  /* sfix18 */
  logic signed [17:0] dout_5_1_im_1;  /* sfix18 */
