// -------------------------------------------------------------
// 
// File Name: C:\Users\Hassa\Documents\GitHub\vocoder\MATLAB\MATLAB_CodeGen\codegen\envelopeModulation\hdlsrc\SDFCommutator1_block1.sv
...
// Source Path: envelopeModulation_fixpt/dsphdl.FFT/RADIX22FFT_SDF1_1/SDFCommutator1
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module SDFCommutator1_block1
          (  input logic clk,
             ...
             input logic signed [13:0] xf_re  /* sfix14 */,
             input logic signed [13:0] xf_im  /* sfix14 */,
             input logic xf_vld,
             input logic signed [13:0] dinXTwdlf_re  /* sfix14 */,
             input logic signed [13:0] dinXTwdlf_im  /* sfix14 */,
             input logic dinxTwdlf_vld,
             input logic signed [13:0] btf1_re  /* sfix14 */,
             input logic signed [13:0] btf1_im  /* sfix14 */,
             input logic signed [13:0] btf2_re  /* sfix14 */,
             input logic signed [13:0] btf2_im  /* sfix14 */,
             input logic btf_vld,
             input logic softReset,
             output logic signed [13:0] wrData_re  /* sfix14 */,
             output logic signed [13:0] wrData_im  /* sfix14 */,
             output logic [8:0] wrAddr  /* ufix9 */,
             output logic wrEnb,
  ...
  logic signed [13:0] SDFCummutator_out_re;  /* sfix14 */
  logic signed [13:0] SDFCummutator_out_im;  /* sfix14 */
  logic SDFCummutator_out_vld;
  logic [8:0] SDFCummutator_wrAddr_reg;  /* ufix9 */
  logic [2:0] SDFCummutator_wrState;  /* ufix3 */
  logic [1:0] SDFCummutator_mem_btf_switch;  /* ufix2 */
  logic [8:0] SDFCummutator_rdCnt;  /* ufix9 */
  logic signed [13:0] SDFCummutator_wrData_re_reg;  /* sfix14 */
  logic signed [13:0] SDFCummutator_wrData_im_reg;  /* sfix14 */
  logic SDFCummutator_wrEnb_reg;
  logic signed [13:0] SDFCummutator_wrXData_re_reg;  /* sfix14 */
  logic signed [13:0] SDFCummutator_wrXData_im_reg;  /* sfix14 */
  ...
  logic signed [13:0] SDFCummutator_out_re_next;  /* sfix14 */
  logic signed [13:0] SDFCummutator_out_im_next;  /* sfix14 */
  logic SDFCummutator_out_vld_next;
  logic [8:0] SDFCummutator_wrAddr_reg_next;  /* ufix9 */
  logic [2:0] SDFCummutator_wrState_next;  /* ufix3 */
  logic [1:0] SDFCummutator_mem_btf_switch_next;  /* ufix2 */
  logic [8:0] SDFCummutator_rdCnt_next;  /* ufix9 */
  logic signed [13:0] SDFCummutator_wrData_re_reg_next;  /* sfix14 */
  logic signed [13:0] SDFCummutator_wrData_im_reg_next;  /* sfix14 */
  logic SDFCummutator_wrEnb_reg_next;
  logic signed [13:0] SDFCummutator_wrXData_re_reg_next;  /* sfix14 */
  logic signed [13:0] SDFCummutator_wrXData_im_reg_next;  /* sfix14 */
  ...
  logic signed [13:0] wrData_re_1;  /* sfix14 */
  logic signed [13:0] wrData_im_1;  /* sfix14 */
  logic [8:0] wrAddr_1;  /* ufix9 */
  logic wrEnb_1;
  logic signed [13:0] xData_re;  /* sfix14 */
  logic signed [13:0] xData_im;  /* sfix14 */
  logic [2:0] wrXAddr;  /* ufix3 */
  logic wrXEnb;
  logic [2:0] rdXAddr;  /* ufix3 */
  logic xX_vld;
  logic signed [13:0] dout0_re;  /* sfix14 */
  logic signed [13:0] dout0_im;  /* sfix14 */
  logic dout0_vld;
  logic signed [13:0] xX_re;  /* sfix14 */
  logic signed [13:0] xX_im;  /* sfix14 */
  logic signed [13:0] SDFOutmux_btf2Pipe_re;  /* sfix14 */
  logic signed [13:0] SDFOutmux_btf2Pipe_im;  /* sfix14 */
  logic SDFOutmux_btfPipe_vld;
  logic signed [13:0] SDFOutmux_btf2Pipe_re_next;  /* sfix14 */
  logic signed [13:0] SDFOutmux_btf2Pipe_im_next;  /* sfix14 */
  logic SDFOutmux_btfPipe_vld_next;
  logic signed [13:0] dout_1_1_re_1;  /* sfix14 */
  logic signed [13:0] dout_1_1_im_1;  /* sfix14 */
