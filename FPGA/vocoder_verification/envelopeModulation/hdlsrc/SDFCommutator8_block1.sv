// -------------------------------------------------------------
// 
// File Name: C:\Users\Hassa\Documents\GitHub\vocoder\MATLAB\MATLAB_CodeGen\codegen\envelopeModulation\hdlsrc\SDFCommutator8_block1.sv
...
// Source Path: envelopeModulation_fixpt/dsphdl.FFT/RADIX22FFT_SDF2_8/SDFCommutator8
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module SDFCommutator8_block1
          (  input logic clk,
             ...
             input logic signed [20:0] xf_re  /* sfix21 */,
             input logic signed [20:0] xf_im  /* sfix21 */,
             input logic xf_vld,
             input logic signed [20:0] dinf_re  /* sfix21 */,
             input logic signed [20:0] dinf_im  /* sfix21 */,
             input logic dinf_vld,
             input logic signed [20:0] btf1_re  /* sfix21 */,
             input logic signed [20:0] btf1_im  /* sfix21 */,
             input logic signed [20:0] btf2_re  /* sfix21 */,
             input logic signed [20:0] btf2_im  /* sfix21 */,
             input logic btfout_vld,
             input logic softReset,
             output logic signed [20:0] wrData_re  /* sfix21 */,
             output logic signed [20:0] wrData_im  /* sfix21 */,
  ...
  logic signed [20:0] SDFCummutator_out_re_next;  /* sfix21 */
  logic signed [20:0] SDFCummutator_out_im_next;  /* sfix21 */
  logic SDFCummutator_out_vld_next;
  logic [1:0] SDFCummutator_wrAddr_reg_next;  /* ufix2 */
  logic [2:0] SDFCummutator_wrState_next;  /* ufix3 */
  logic signed [20:0] SDFCummutator_wrData_re_reg_next;  /* sfix21 */
  logic signed [20:0] SDFCummutator_wrData_im_reg_next;  /* sfix21 */
  logic SDFCummutator_wrEnb_reg_next;
  logic signed [20:0] SDFCummutator_wrXData_re_reg_next;  /* sfix21 */
  logic signed [20:0] SDFCummutator_wrXData_im_reg_next;  /* sfix21 */
  ...
  logic signed [20:0] wrData_re_1;  /* sfix21 */
  logic signed [20:0] wrData_im_1;  /* sfix21 */
  logic [1:0] wrAddr_1;  /* ufix2 */
  logic wrEnb_1;
  logic signed [20:0] xData_re;  /* sfix21 */
  logic signed [20:0] xData_im;  /* sfix21 */
  logic [2:0] wrXAddr;  /* ufix3 */
  logic wrXEnb;
  logic [2:0] rdXAddr;  /* ufix3 */
  logic xX_vld;
  logic signed [20:0] dout0_re;  /* sfix21 */
  logic signed [20:0] dout0_im;  /* sfix21 */
  logic dout0_vld;
  logic signed [20:0] xX_re;  /* sfix21 */
  logic signed [20:0] xX_im;  /* sfix21 */
  logic signed [20:0] SDFOutmux_btf2Pipe_re;  /* sfix21 */
  logic signed [20:0] SDFOutmux_btf2Pipe_im;  /* sfix21 */
  logic SDFOutmux_btfPipe_vld;
  logic signed [20:0] SDFOutmux_btf2Pipe_re_next;  /* sfix21 */
  logic signed [20:0] SDFOutmux_btf2Pipe_im_next;  /* sfix21 */
  logic SDFOutmux_btfPipe_vld_next;
  logic signed [20:0] dout_8_1_re_1;  /* sfix21 */
  logic signed [20:0] dout_8_1_im_1;  /* sfix21 */
...
endmodule  // SDFCommutator8_block1
