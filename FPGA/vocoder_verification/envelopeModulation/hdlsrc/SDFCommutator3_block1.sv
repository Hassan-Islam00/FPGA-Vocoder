// -------------------------------------------------------------
// 
// File Name: C:\Users\Hassa\Documents\GitHub\vocoder\MATLAB\MATLAB_CodeGen\codegen\envelopeModulation\hdlsrc\SDFCommutator3_block1.sv
...
// Source Path: envelopeModulation_fixpt/dsphdl.FFT/RADIX22FFT_SDF1_3/SDFCommutator3
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module SDFCommutator3_block1
          (  input logic clk,
             ...
             input logic signed [15:0] xf_re  /* sfix16 */,
             input logic signed [15:0] xf_im  /* sfix16 */,
             input logic xf_vld,
             input logic signed [15:0] dinXTwdlf_re  /* sfix16 */,
             input logic signed [15:0] dinXTwdlf_im  /* sfix16 */,
             input logic dinxTwdlf_vld,
             input logic signed [15:0] btf1_re  /* sfix16 */,
             input logic signed [15:0] btf1_im  /* sfix16 */,
             input logic signed [15:0] btf2_re  /* sfix16 */,
             input logic signed [15:0] btf2_im  /* sfix16 */,
             input logic btf_vld,
             input logic softReset,
             output logic signed [15:0] wrData_re  /* sfix16 */,
             output logic signed [15:0] wrData_im  /* sfix16 */,
  ...
  logic signed [15:0] SDFCummutator_out_re;  /* sfix16 */
  logic signed [15:0] SDFCummutator_out_im;  /* sfix16 */
  ...
  logic signed [15:0] SDFCummutator_wrData_re_reg;  /* sfix16 */
  logic signed [15:0] SDFCummutator_wrData_im_reg;  /* sfix16 */
  logic SDFCummutator_wrEnb_reg;
  logic signed [15:0] SDFCummutator_wrXData_re_reg;  /* sfix16 */
  logic signed [15:0] SDFCummutator_wrXData_im_reg;  /* sfix16 */
  ...
  logic signed [15:0] SDFCummutator_out_re_next;  /* sfix16 */
  logic signed [15:0] SDFCummutator_out_im_next;  /* sfix16 */
  ...
  logic signed [15:0] SDFCummutator_wrData_re_reg_next;  /* sfix16 */
  logic signed [15:0] SDFCummutator_wrData_im_reg_next;  /* sfix16 */
  logic SDFCummutator_wrEnb_reg_next;
  logic signed [15:0] SDFCummutator_wrXData_re_reg_next;  /* sfix16 */
  logic signed [15:0] SDFCummutator_wrXData_im_reg_next;  /* sfix16 */
  ...
  logic signed [15:0] wrData_re_1;  /* sfix16 */
  logic signed [15:0] wrData_im_1;  /* sfix16 */
  logic [6:0] wrAddr_1;  /* ufix7 */
  logic wrEnb_1;
  logic signed [15:0] xData_re;  /* sfix16 */
  logic signed [15:0] xData_im;  /* sfix16 */
  logic [2:0] wrXAddr;  /* ufix3 */
  logic wrXEnb;
  logic [2:0] rdXAddr;  /* ufix3 */
  logic xX_vld;
  logic signed [15:0] dout0_re;  /* sfix16 */
  logic signed [15:0] dout0_im;  /* sfix16 */
  logic dout0_vld;
  logic signed [15:0] xX_re;  /* sfix16 */
  logic signed [15:0] xX_im;  /* sfix16 */
  logic signed [15:0] SDFOutmux_btf2Pipe_re;  /* sfix16 */
  logic signed [15:0] SDFOutmux_btf2Pipe_im;  /* sfix16 */
  logic SDFOutmux_btfPipe_vld;
  logic signed [15:0] SDFOutmux_btf2Pipe_re_next;  /* sfix16 */
  logic signed [15:0] SDFOutmux_btf2Pipe_im_next;  /* sfix16 */
  logic SDFOutmux_btfPipe_vld_next;
  logic signed [15:0] dout_3_1_re_1;  /* sfix16 */
  logic signed [15:0] dout_3_1_im_1;  /* sfix16 */
